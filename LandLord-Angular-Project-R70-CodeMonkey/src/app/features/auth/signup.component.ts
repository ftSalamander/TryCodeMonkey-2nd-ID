...
/**
 * Mirrors the login-activity diagram's signup branch: account type ->
 * personal info -> terms -> OTP, collapsed into one wizard page.
 */
@Component({
  selector: 'app-signup',
  standalone: true,
...
export class SignupComponent {
  ...
  verifyOtp(): void {
    ...
    this.router.navigateByUrl(this.accountType === 'landlord' ? '/landlord/dashboard' : '/tenant/dashboard');
  }
}
